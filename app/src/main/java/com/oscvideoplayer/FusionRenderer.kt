    ...
    private fun buildMesh(){
        ...
        for(r in 0 until rows-1)for(c in 0 until cols-1){
            ...
            for(sr in 0 until sub)for(sc in 0 until sub){
                ...
                emit(sx(fu,fv),sy(fu,fv),tu,tv);emit(sx(fu1,fv),sy(fu1,fv),tu1,tv);emit(sx(fu,fv1),sy(fu,fv1),tu,tv1)
                emit(sx(fu1,fv),sy(fu1,fv),tu1,tv);emit(sx(fu1,fv1),sy(fu1,fv1),tu1,tv1);emit(sx(fu,fv1),sy(fu,fv1),tu,tv1)
            }
        }
        vertBuffer.position(0)
    }
